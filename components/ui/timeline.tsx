      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-10">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky hidden w-full max-w-[230px] md:flex flex-col md:flex-row z-40 items-center top-40 self-start">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-darkBackground border border-borderDark dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-secondary border-accent dark:bg-neutral-800 border dark:border-neutral-700 p-2" />
              </div>
              <h3 className="hidden md:flex items-center h-10 md:pl-20 font-bold text-accent">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-accent/50 via-secondary/50 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
